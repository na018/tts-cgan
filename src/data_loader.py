...
class MitbihTrainDataLaoder(Dataset):
    def __init__(self, filename='./data/mitbih_train.csv', n_samples=20000, oneD=False):
        ...
        print(
            f'The dataset including {len(data_0_resample)} class 0, {len(data_1_resample)} class 1, '
            f'{len(data_2_resample)} class 2, {len(data_3_resample)} class 3, {len(data_4_resample)} class 4')
...
class MitbihTestDataLoader(Dataset):
    def __init__(self, filename='./data/mitbih_test.csv', n_samples=1000, oneD=False):
        ...
        print(
            ...
            f'{len(data_3)} class 3, {len(data_4)} class 4')
